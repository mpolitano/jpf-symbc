...
import abstraction.JPF_abstraction_function;
import abstraction.Values;
...
//	}
	...
	private static final int FIELD_BMC_ABSTRACTION = 5;
...
//	private static String getAbstractedStateFields(MJIEnv env, int objvRef){
//		
//	}
 	public static int checkAndUpdateAbstractStatesSeenSoFarField(Map<String, Values> state){
...
//				abstractedState = getFieldBMCAbstractedState(env, objvRef);
//				System.out.println(abstractedState);
//				break;
//				//-----------------------------------------------------
